...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Holy Fathima High School, New Hafeezpet — Building Bright Futures Since 1989" },
      { name: "description", content: "Premium English-medium school in New Hafeezpet, Hyderabad offering Nursery to Class 10 — CBSE primary and SSC high school with experienced faculty, modern facilities and a safe campus." },
      { property: "og:title", content: "Holy Fathima High School, New Hafeezpet" },
      { property: "og:description", content: "English-medium education from Nursery to Class 10 in New Hafeezpet, Hyderabad. Building bright futures since 1989." },
